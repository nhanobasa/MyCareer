...
public class SignupActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        btnRegister = findViewById(R.id.btn_register_in_signup);
    ...
    private void customLogin() {
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (p.isEmpty()) {
                    password.setError("Password is not blankr!");
                    return;
                }

                if (p.length() < 6) {
                    password.setError("Password is more longer than 6 character!");
                    return;
                }
                ...
                auth.createUserWithEmailAndPassword(e, p)
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull @NotNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(getApplicationContext(), "Register Sucsessful", Toast.LENGTH_SHORT).show();
                                    finish();
                                } else {
